<section class="container-nav grid-12-nav nav-desktop">
    ...
    <article class="social">
        ...
        <a href="javascript:void(0)" id="search-icon-link">
            ...
            <img id="search-icon" onclick="Trazilica()" src="<?php echo get_stylesheet_directory_uri(); ?>/slike/search.png" alt="icv-search">
        
            <img id="close-icon" onclick="Trazilica()" src="<?php echo get_stylesheet_directory_uri();?>/slike/close.png" alt="closeicon">
