<section class="container-nav grid-12-nav nav-mob">
    ...
    <article class="menu-mob">
        ...
        <a href="javascript:void(0)" id="search-icon-link2">
            ...
            <img id="search-icon2" onclick="Trazilica()" src="<?php echo get_stylesheet_directory_uri(); ?>/slike/search-white.png" alt="icv-search">
        
            <img id="close-icon2" onclick="Trazilica()" src="<?php echo get_stylesheet_directory_uri();?>/slike/close.png" alt="closeicon">
